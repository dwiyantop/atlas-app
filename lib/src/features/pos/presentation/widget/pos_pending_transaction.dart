...
class PosPendingTransaction extends StatefulWidget {
  const PosPendingTransaction({super.key});

  @override
  State<PosPendingTransaction> createState() => _PosPendingTransactionState();
}

class _PosPendingTransactionState extends State<PosPendingTransaction> {
  @override
